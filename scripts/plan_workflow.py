...
MODULE_DEFS = {
    ...
    "knowledge_walkthrough_docx_generation": {
        ...
        "qa_checks": ["reference walkthrough DOCX format", "2.0 cm margins", "1.5 line spacing", "justified body text", "left-aligned headings", "black Arial text", "knowledge walkthrough linter", "public output boundary", "final user revision checklist", "rendered DOCX visual check when tooling is available"],
    },
    "knowledge_walkthrough_docx_style_linter": {
        "action_type": "LintKnowledgeWalkthroughDocxStyle",
        "minimum_inputs": ["PrepArtifact", "RouteDocxStyleProfile"],
        "expected_outputs": ["QAFlag"],
        "qa_checks": ["black text", "Arial", "2.0 cm margins", "1.5 line spacing", "justified body text", "left-aligned headings", "no blue or theme text", "no internal workflow headings", "no user-forbidden punctuation when requested", "image preservation when requested"],
    },
    "exam_regime": {
    ...
    "exam_prep_notes_docx_generation": {
        ...
        "expected_outputs": ["PrepArtifact"],
        "qa_checks": [
            "reference exam prep DOCX format",
            "2.0 cm margins",
            "1.5 line spacing",
            "justified body text",
            ...
            "final user revision checklist",
            "rendered DOCX visual check when tooling is available",
        ],
    },
    "exam_prep_docx_style_linter": {
        ...
        "expected_outputs": ["QAFlag"],
        "qa_checks": ["black text", "Arial", "2.0 cm margins", "1.5 line spacing", "justified body text", "left-aligned headings", "no blue or theme text", "no internal card or workflow headings", "no user-forbidden punctuation when requested", "image preservation when requested"],
    },
    "exam_prep_notes_linter": {
