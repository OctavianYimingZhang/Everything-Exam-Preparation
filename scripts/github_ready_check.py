...
def main() -> None:
    ...
    run("example essay docx format linter", [sys.executable, "scripts/docx_format_linter.py", "--self-test"])
    ...
    run("public notes docx linter", [sys.executable, "scripts/public_notes_docx_linter.py", "--self-test"])
