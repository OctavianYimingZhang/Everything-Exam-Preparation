...
Extra Reading is mainly used for Essay Question and Example Essay enrichment, where external evidence, mechanism depth, molecular evidence, counterargument, and evaluation can help earn Extra Reading credit. Use it in other outputs when the user explicitly asks for that enrichment or when it directly strengthens a confirmed essay-style add-on.
