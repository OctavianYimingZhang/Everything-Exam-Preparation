...
- Exam type or route: MCQ, short answer, long answer, practical/data/problem, worked solutions, essay, or mixed.
...
Automatic diagnosis is preliminary. Before generating Notes, Specific Research Reports, or Worked Solutions, display the Auto-diagnosis review plan and use `request_user_input` to confirm or correct Exam type/route, Material type/source roles, and whether Notes should be generated.
